  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F5E6D3] to-white">
      ...
      <section className="relative min-h-[600px] md:h-[600px] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center py-20 md:py-0" dir="rtl">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-6 font-['Cairo'] leading-tight">
              تجربة قهوة مختصة
              <br />
              <span className="text-[#D4A574]">من المملكة</span>
            </h1>

            <p className="text-base sm:text-lg md:text-xl text-[#F5E6D3] mb-8 font-['Cairo'] leading-relaxed">
            ...
            <div className="flex gap-4 flex-wrap">
              <Link
                to="/products"
                className="bg-gradient-to-r from-[#D4A574] to-[#B8956A] text-[#2B1D17] px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold hover:shadow-2xl transition-all text-base sm:text-lg font-['Cairo']"
              >
                تسوق الآن
              </Link>
              ...
              <a
                href="#about"
                className="bg-white/10 backdrop-blur-sm text-white border-2 border-white/30 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold hover:bg-white/20 transition-all text-base sm:text-lg font-['Cairo']"
              >
                اكتشف المزيد
              </a>
            </div>
        ...
        {/* Trust Badges */}
        <div className="md:absolute md:bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-[#6D4C41]/20">
